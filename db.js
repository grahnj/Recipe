function db(){
	...
	db.execute("BEGIN TRANSACTION;" +
		...
		"-- Table: INGREDIENT" +
		"CREATE TABLE IF NOT EXISTS INGREDIENT (INGREDIENT_ID INTEGER (10) PRIMARY KEY UNIQUE NOT NULL, RECIPE_ID INTEGER (10) REFERENCES RECIPE (RECIPE_ID) NOT NULL, NAME VARCHAR (50) NOT NULL, AMOUNT DECIMAL (5) NOT NULL, MEASUREMENT_TYPE INTEGER (1) NOT NULL, MEASUREMENT_VALUE INTEGER (1) NOT NULL);" + 
		...
		"-- Table: STEP" +
		"CREATE TABLE IF NOT EXISTS STEP (ID INTEGER (10) PRIMARY KEY UNIQUE NOT NULL, RECIPE_ID INTEGER (10) REFERENCES RECIPE (RECIPE_ID) NOT NULL, STEP_NUMBER INTEGER (2) NOT NULL, DETAILS STRING (400) NOT NULL);" +
